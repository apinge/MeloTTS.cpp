...
namespace melo {
    ...
    namespace chinese_mix {
        std::tuple<std::vector<std::string>, std::vector<int64_t>, std::vector<int>> _g2p_v2(const std::string& segment, 
            std::shared_ptr<Tokenizer>& tokenized, std::shared_ptr<cppjieba::Jieba>& jieba, std::shared_ptr<CMUDict>& cmudict);
        ...
        std::tuple<std::vector<std::string>, std::vector<int64_t>, std::vector<int>> g2p_en(const std::string& word, std::vector<std::string>& tokenized, std::shared_ptr<CMUDict>& cmudict);
