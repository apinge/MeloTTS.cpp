...
namespace melo {
    class TTS {
        public:
            ...
            void tts_to_file(const std::string& text, const std::string& output_filename, const int& speaker_id, const float& speed = 1.0f,
            ...
            void tts_to_file(const std::string& text, std::vector<float>& output_audio, const int& speaker_id, const float& speed = 1.0f,
                const float& sdp_ratio = 0.2f, const float& noise_scale = 0.6f, const float& noise_scale_w = 0.8f);
            void tts_to_file(const std::vector<std::string>& texts, const std::string& output_filename, const int& speaker_id, const float& speed = 1.0f,
                const float& sdp_ratio = 0.2f, const float& noise_scale = 0.6f, const float& noise_scale_w = 0.8f);
            ...
            static void write_wave(const std::string& output_filename, const std::vector<float>& wave, const int32_t& sampling_rate);
